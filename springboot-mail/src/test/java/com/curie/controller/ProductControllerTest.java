...
public class ProductControllerTest {
    ...
    public void getProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", equalTo("蘋果（日本北海道）")))
    ...
    public void updateProduct_productNotFound() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .put("/updateProduct/{productId}", 20000)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json);
    ...
    public void deleteProduct_success() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .delete("/deleteProduct/{productId}", 7);
    ...
    public void deleteProduct_deleteNonExistingProduct() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .delete("/deleteProduct/{productId}", 20000);
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.result", hasSize(5)))
                .andExpect(jsonPath("$.result[0].productId", equalTo(11)))
                .andExpect(jsonPath("$.result[1].productId", equalTo(10)))
                .andExpect(jsonPath("$.result[2].productId", equalTo(12)))
                .andExpect(jsonPath("$.result[3].productId", equalTo(9)))
